...
public interface CustomerController {
    ...
    @Operation(summary = "Find Customer by ID", description = "This endpoint is by find customer by id")
    ResponseEntity<EntityModel<CustomerDTO>> findCustomerById(Long id);

    @Operation(summary = "Delete Customer", description = "This endpoint is by delete customer")
    ResponseEntity<Void> deleteCustomer(Long id);

    @Operation(summary = "Update Customer", description = "This endpoint is by update customer")
    ResponseEntity<EntityModel<CustomerDTO>> updateCustomer(Long id,
                                                            CustomerDTO request);
